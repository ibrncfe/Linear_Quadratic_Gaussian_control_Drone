...
<Project Type="Project" LVVersion="11008008">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="SubVI" Type="Folder">
			<Item Name="analysis_TimeResponse.vi" Type="VI" URL="../SubVI/analysis_TimeResponse.vi"/>
			<Item Name="disturbance.vi" Type="VI" URL="../SubVI/disturbance.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="3DMotion.vi" Type="VI" URL="../SubVI/3DMotion.vi"/>
			<Item Name="alt change indicator.vi" Type="VI" URL="../SubVI/lib/alt change indicator.vi"/>
			<Item Name="altitude.vi" Type="VI" URL="../SubVI/lib/altitude.vi"/>
			<Item Name="calc_moved direction.vi" Type="VI" URL="../SubVI/lib/calc_moved direction.vi"/>
			<Item Name="compass.vi" Type="VI" URL="../SubVI/lib/compass.vi"/>
			<Item Name="compass_aroplane.vi" Type="VI" URL="../SubVI/lib/compass_aroplane.vi"/>
			<Item Name="compass_EWSN.vi" Type="VI" URL="../SubVI/lib/compass_EWSN.vi"/>
			<Item Name="compass_lines.vi" Type="VI" URL="../SubVI/lib/compass_lines.vi"/>
			<Item Name="E_W_S_N on sphere.vi" Type="VI" URL="../SubVI/lib/E_W_S_N on sphere.vi"/>
			<Item Name="fake_rotate_instability.vi" Type="VI" URL="../SubVI/lib/fake_rotate_instability.vi"/>
			<Item Name="fill half sphere.vi" Type="VI" URL="../SubVI/lib/fill half sphere.vi"/>
			<Item Name="gyro_horizon.vi" Type="VI" URL="../SubVI/lib/gyro_horizon.vi"/>
			<Item Name="horizon_line.vi" Type="VI" URL="../SubVI/lib/horizon_line.vi"/>
			<Item Name="instrument.vi" Type="VI" URL="../SubVI/lib/instrument.vi"/>
			<Item Name="instrument_ring.vi" Type="VI" URL="../SubVI/lib/instrument_ring.vi"/>
			<Item Name="latt_grid.vi" Type="VI" URL="../SubVI/lib/latt_grid.vi"/>
			<Item Name="long_grid.vi" Type="VI" URL="../SubVI/lib/long_grid.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/C/Program Files (x86)/National Instruments/LabVIEW 2011/resource/lvanlys.dll"/>
			<Item Name="needle.vi" Type="VI" URL="../SubVI/lib/needle.vi"/>
			<Item Name="rolling_digit.vi" Type="VI" URL="../SubVI/lib/rolling_digit.vi"/>
			<Item Name="rolling_number.vi" Type="VI" URL="../SubVI/lib/rolling_number.vi"/>
			<Item Name="x_rotmatrix.vi" Type="VI" URL="../SubVI/lib/x_rotmatrix.vi"/>
			<Item Name="xyz_movematrix.vi" Type="VI" URL="../SubVI/lib/xyz_movematrix.vi"/>
			<Item Name="y_rotmatrix.vi" Type="VI" URL="../SubVI/lib/y_rotmatrix.vi"/>
			<Item Name="z_rotmatrix.vi" Type="VI" URL="../SubVI/lib/z_rotmatrix.vi"/>
		</Item>
